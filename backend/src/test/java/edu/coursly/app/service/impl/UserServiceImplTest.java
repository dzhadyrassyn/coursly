...
class UserServiceImplTest {
    ...
    void should_throw_if_username_is_null() {
        ...
        Exception ex = assertThrows(NullPointerException.class, () -> userService.registerUser(request));
    ...
    void should_throw_if_dto_is_null() {
        Exception ex = assertThrows(NullPointerException.class, () -> userService.registerUser(null));
